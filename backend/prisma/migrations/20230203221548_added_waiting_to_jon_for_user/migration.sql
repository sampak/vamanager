...
-- DropIndex
DROP INDEX `VerificationCodes_userId_fkey` ON `verificationcodes`;

-- AlterTable
ALTER TABLE `users` MODIFY `status` ENUM('ACTIVE', 'NON_ACTIVE', 'SUSPENDED', 'PENDING_CODE', 'WAITING_TO_JOIN') NOT NULL DEFAULT 'ACTIVE';
