/*
  ...
  - You are about to drop the column `type` on the `aircraftsdealer` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE `aircraftsdealer` DROP COLUMN `type`,
    ADD COLUMN `typeId` VARCHAR(191) NOT NULL DEFAULT '';
