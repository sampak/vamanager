/*
  ...
  - You are about to drop the column `manufacture` on the `aircrafts` table. All the data in the column will be lost.
  - You are about to drop the column `manufacture` on the `aircraftsdealer` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE `aircrafts` DROP COLUMN `manufacture`;

-- AlterTable
ALTER TABLE `aircraftsdealer` DROP COLUMN `manufacture`;
