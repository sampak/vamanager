/*
  ...
  - Added the required column `elevation_ft` to the `Airports` table without a default value. This is not possible if the table is not empty.
  - Added the required column `iata` to the `Airports` table without a default value. This is not possible if the table is not empty.
  - Added the required column `keywords` to the `Airports` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE `airports` ADD COLUMN `elevation_ft` DOUBLE NOT NULL,
    ADD COLUMN `iata` VARCHAR(191) NOT NULL,
