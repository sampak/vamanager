...
-- AlterTable
ALTER TABLE `aircrafts` ADD COLUMN `manufacture` VARCHAR(191) NOT NULL DEFAULT '';

-- AlterTable
ALTER TABLE `aircraftsdealer` ADD COLUMN `manufacture` VARCHAR(191) NOT NULL DEFAULT '';
